...
This assignment documents the installation and configuration of the development environment for LIS4368, including Git, BitBucket, Java JDK, and Apache Tomcat. It also demonstrates the successful execution of a Java Hello World program and the ability to run a web appli>
