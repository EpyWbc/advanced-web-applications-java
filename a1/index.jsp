...
<!-- can also find path like this...<a href="${pageContext.request.contextPath}${'/a5/index.jsp'}">A5</a> -->
	...
	<div class="container">
		<div class="starter-template">
					...
					<img src="img/lis4368-a1-img-javahello.png" class="img-responsive center-block" alt="JDK Installation" />

					<br /> <br />
					<b>Tomcat Installation:</b><br />
					<img src="img/lis4368-a1-img-tomcat.png" class="img-responsive center-block" alt="Tomcat Installation" />
